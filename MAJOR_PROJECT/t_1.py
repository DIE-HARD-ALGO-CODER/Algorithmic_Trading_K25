...
def main():
    ...
    # Main options
    option = st.radio("Select Analysis Type:", ["Image Analysis", "Mass Transfer Analysis"])
    
    if option == "Image Analysis":
        st.info("Image Analysis module is under development. Please check back later.")
    
    elif option == "Mass Transfer Analysis":
